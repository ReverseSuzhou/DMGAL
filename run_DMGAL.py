...
class Learner:
    ...
    def parse_command_line(self):
        ...
        parser.add_argument("--dataset", choices=["ssv2", "kinetics", "hmdb", "ucf", "diving"], default="hmdb",
                            help="Dataset to use.")
        parser.add_argument("--learning_rate", "-lr", type=float, default=0.00015, help="Learning rate.")
        ...
        parser.add_argument("--test_model_path", "-m",
                            default='/home/ywc/code/PRCV_cmn/checkpoint_resnet50_1shot_ssv2cmn_our/checkpoint300.pt',
